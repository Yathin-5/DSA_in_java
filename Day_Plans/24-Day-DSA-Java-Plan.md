...
Day 02: ⬜ Math Basics          Day 14: ⬜ Graphs Basics
...
| File | What You'll Learn |
|------|------------------|
| `Logarithms.java` | Log base conversions, binary search log analysis |
| `ModularArithmetic.java` | Modular exponentiation, modular inverse, BigInteger |
| `PrimeNumbers.java` | Trial division, Miller-Rabin primality test |
| `GCD_LCM.java` | Euclidean algorithm, extended GCD |
| `SieveOfEratosthenes.java` | Classic sieve + segmented sieve with BitSet |

**Practice**: Project Euler problems 3, 7, 10, 50
